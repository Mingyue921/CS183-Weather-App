...
| Chen Chuqi | 25126251 | Express APIs, authentication, MongoDB, favorites, weather alerts, AI forwarding | Chatree-Q |
| Huang Xinlei | 25125443 | Mobile UI design, icons, layout style, color system, solar term visual presentation; also assisted web frontend members with selected web UI implementation and visual polishing | xinleihuang149-svg |
| Huang Yichen | 25125451 | React web structure, Dashboard, Saved Location, Calendar, AI Helper, Settings | 3dfisnt |
| Yang Qiyuan | 25124463 | Web dashboard UI, sidebar, cards, login/settings visual design | Sally-design968 |
